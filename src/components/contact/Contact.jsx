...
import { AlertMessageError } from "../alertMessageSuccess/alertMessageError/AlertMessageError";
    ...
    <>
      <motion.div
        ...
        <motion.div className="textContainer" variants={variants}>
          ...
          <motion.div className="item card" variants={variants}>
            <h2>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="128"
            ...
            <a href="https://www.linkedin.com/in/horacio-jose-martinez-971887269/">
              horacio-jose-martinez
            </a>
          </motion.div>
          <motion.div className="item card" variants={variants}>
            <h2 className="social-link2">
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="124"
            ...
            <a href="https://github.com/HoracioMartinez17">HoracioMartinez17</a>
          </motion.div>
        </motion.div>
        <div className="formContainer">
          ...
          >
            ...
            <textarea rows={7} required placeholder="Mensaje" name="message" />
            <button className="btn" type="submit">
              ...
              <div id="glow">
                ...
                {isLoading && <Loader />}
      {error && <AlertMessageError test= 'Ocurrior un error al enviar el mensaje.'/>}
      {success && <AlertMessageSuccess text= 'El mensaje ha sido enviado!'/>}
          </motion.form>
